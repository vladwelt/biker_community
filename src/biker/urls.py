...
urlpatterns = [
        ...
        url(r'event/add/$', EventoCreate.as_view(), name='event-add'),
        url(r'event/delete/(?P<pk>[0-9]+)/$', EventoDelete.as_view(), name='event-delete'),
        url(r'event/detail/(?P<pk>[0-9]+)/$', EventoDetail.as_view(), name='event-detail'),
        url(r'event/update/(?P<pk>[0-9]+)/$', EventoUpdate.as_view(), name='event-update'),
